...
#define RT_SENSOR_VENDOR_HONEYWELL     (15) /* Honeywell */
#define RT_SENSOR_VENDOR_MEMSIC        (16) /* MEMSIC */
...
/**
 * @param   dev_name: 设备名称 "i2c2"
 * @param   type: 接口类型 RT_SENSOR_INTF_xxx 这个好像和  重复
 * @param   user_data: 在IIC中是设备的七位从地址
 **/
